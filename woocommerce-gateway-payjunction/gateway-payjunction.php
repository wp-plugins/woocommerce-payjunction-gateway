...
Plugin URI: http://support.sbsake.com/knowledge_base/topics/woocommerce
Description: The PayJunction payment gateway plugin for WooCommerce. Accept all major credit cards directly on your WooCommerce site in a seamless and secure checkout environment with Payjunction. <a href="http://pricing.payjunction.com/woothemes" target="_blank">Click Here</a> to get a PayJunction account.
Version: 1.0.2
Author: SBSAKE
...
if (is_admin()) {
	...
	$woo_plugin_updater_payjunction = new WooThemes_Plugin_Updater( __FILE__ );
	$woo_plugin_updater_payjunction->api_key = '94a7a543dcdb55187b3a4e7d60a437af';
	$woo_plugin_updater_payjunction->init();
}
...
function woocommerce_payjunction_init() {
	...
	class WC_Gateway_PayJunction extends WC_Payment_Gateway {
		...
		function admin_options() {
	    	...
	    	<p><?php _e( 'PayJunction works by adding credit card fields on the checkout and then sending the details to PayJunction for verification. You must first have a Payjunction Account to accept credit card and debit card payments. You can get an account at <a href="http://pricing.payjunction.com/woothemes" target="_blank"> <b>Payjunction</b></a>. If you have any questions or like a Free Rate Analysis you can <a href="http://www.sbsake.com/contact-us" target="_blank"> <b>contact us</b></a> anytime.  ', 'woothemes' ); ?></p>
