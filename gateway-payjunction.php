...
function woocommerce_payjunction_init() {
 	...
 	* Gateway class
 	**/
	class woocommerce_payjunction extends woocommerce_payment_gateway {
		...
		function get_country_code() {
			...
			if(isset($_GET['order_id'])) {
				...
				$order = &new woocommerce_order($_GET['order_id']);
	...
	function add_payjunction_gateway($methods) {
		$methods[] = 'woocommerce_payjunction';
		return $methods;
	}
